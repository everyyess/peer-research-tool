...
import { normalizeDartOrders } from "@/app/lib/dart-order-normalizer";
...
export async function GET(request: NextRequest) {
  ...
  try { return NextResponse.json(normalizeDartOrders(await getDartOrders(stockCode, apiKey)), { headers }); }
  catch (error) {
